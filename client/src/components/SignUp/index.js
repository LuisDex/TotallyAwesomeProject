                            ...
                            <div className="registerForm">
                                ...
                                <form>
                                    ...
                                    <div className="custom-control custom-radio">
                                        <input type="radio" id="userRadio" name="customRadio" className="custom-control-input"/>
                                        <label className="custom-control-label" htmlFor="userRadio">I am a User</label>
                                    </div>
                                    <div className="custom-control custom-radio">
                                        <input type="radio" id="storeRadio" name="customRadio" className="custom-control-input"/>
                                        <label className="custom-control-label" htmlFor="storeRadio">I am a Store</label>
                                    </div>
